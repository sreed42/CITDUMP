...
mike = Player(1, input(), random.randint(19, 24), random.randint(4, 7), [round(random.uniform(0.9, 1.1), 2),
              round(random.uniform(0.9, 1.1), 2), round(random.uniform(0.9, 1.1), 2), round(random.uniform(0.9, 1.1), 2)])

print("Hello", mike.tellname(), "you are in a terrible dungeon full of horrible monsters. Use your color skills to "
      "defeat them.\n0 does a red attack, 1 does a blue attack, 2 does a yellow attack and "
      "3 does a green attack\n")
time.sleep(1)
...
while True:
    ...
    if room1.returnexits() == 1:
        ...
        print("You see a", seth.tellcolor(), seth.tellname(), "to your left and you see a", slime.tellcolor(),
        ...
        print("You see a", seth.tellcolor(), seth.tellname(), "to your left, a", slime.tellcolor(),
              slime.tellname(), "to your right and you see a", ben.tellcolor(), ben.tellname(), "in front of you\n")
    ...
    if direction == 'l':
        ...
        while seth.hpvalue > 0:
            seth.tellhp()
            print(seth.tellname(), "hits you for", mike.minushp(seth.fight(), seth.returncolor()),
                  "points of damage!\n")
            print("You have", mike.returnhp(), "hit points\n")
            if mike.returnhp() <= 0:
                break
        ...
        if seth.hpvalue <= 0:
            print("You killed the", seth.tellname())
        ...
        while slime.hpvalue > 0:
            slime.tellhp()
            print(slime.tellname(), "hits you for", mike.minushp(slime.fight(), slime.returncolor()),
                  "points of damage!\n")
            print("You have", mike.returnhp(), "hit points\n")
            if mike.returnhp() <= 0:
                break
        ...
        if slime.hpvalue <= 0:
            print("You killed the", slime.tellname())
        ...
        if ben.hpvalue <= 0:
            print("You killed the", ben.tellname())
